...
def report():
    ...
    if request.method == "POST":
        ...
        report_df.to_excel("data/report.xlsx", index=False)
...
@login_required
def download():
    return send_file("data/report.xlsx", as_attachment=True)
